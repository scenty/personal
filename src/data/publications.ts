...
export const publications: Publication[] = [
  ...
  {
    id: "liu-2024-om",
    authors: "刘勇，卢文芳*，王栋，来志刚，应超，韩莹，王智峰，董昌明",
    authorsEn: "Liu, Y., Lu, W.*, Wang, D., Lai, Z., Ying, C., Han, Y., Wang, Z., & Dong, C.",
    year: 2024,
  ...
  {
    id: "wang-2022-aos",
    authors: "王天浩，孙玉，苏华，卢文芳*",
    authorsEn: "Wang, T., Sun, Y., Su, H., & Lu, W.*",
    year: 2022,
  ...
  {
    id: "lu-2022-rs-bloom",
    authors: "卢文芳，高心雨，吴泽伦，王天浩，林少文，肖灿博，来志刚*",
    authorsEn: "Lu, W., Gao, X., Wu, Z., Wang, T., Lin, S., Xiao, C., & Lai, Z.*",
    year: 2022,
  ...
  {
    id: "lu-2022-jgr",
    authors: "卢文芳，王建，江毓武，陈佐旗，吴文挺，刘勇*",
    authorsEn: "Lu, W., Wang, J., Jiang, Y., Chen, Z., Wu, W., & Liu, Y.*",
    year: 2022,
